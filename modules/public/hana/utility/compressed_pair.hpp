...
namespace hana::internal
{
	...
	class HANA_EBCO compressed_pair_element {
		using reference = T&;
	...
	class HANA_EBCO compressed_pair_element<T, Tag> : public T {
		using reference = T&;
		using const_reference = const T&;
...
namespace hana
{
	...
	class HANA_EBCO compressed_pair
...
{
	template<typename First, typename Second>
	struct tuple_size<hana::compressed_pair<First, Second>> : integral_constant<size_t, 2u> {};

	template<size_t Index, typename First, typename Second>
	struct tuple_element<Index, hana::compressed_pair<First, Second>> : conditional<Index == 0u, First, Second> {
